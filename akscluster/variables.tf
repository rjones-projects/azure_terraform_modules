...
variable "environment" {
  description = "(Required) The environment for the resources created in the specified Azure Resource Group"
  type        = string
}
...
variable "pod_subnet_id" {
  description = "(Optional) The ID of a Subnet where the Kubernetes pods should exist. Changing this forces a new resource to be created."
  type        = string
  default     = null
}
