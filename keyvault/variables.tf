...
variable "unique_id" {
  description = "The ID to append to the Name of the key vault"
  default     = ""
}

variable "environment" {
  description = "The environment name of the key vault"
  default     = "uksouth"
}
...
variable "existing_private_dns_zone_resource_group" {
  description = "Name of the existing private DNS zone rg"
  default     = null
}
