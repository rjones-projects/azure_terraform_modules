  ...
  dynamic "rewrite_rule_set" {
    ...
    content {
      ...
      dynamic "rewrite_rule" {
        for_each = rewrite_rule_set.value.rewrite_rules != null ? lookup(rewrite_rule_set.value, "rewrite_rules", {}) : []
        content {
          name          = rewrite_rule.value.name
          rule_sequence = rewrite_rule.value.rule_sequence

          dynamic "condition" {
            for_each = rewrite_rule.value.condition != null ? lookup(rewrite_rule.value, "condition", {}) : []
            content {
          ...
          dynamic "request_header_configuration" {
            for_each = rewrite_rule.value.request_header_configuration != null ? lookup(rewrite_rule.value, "request_header_configuration", {}) : []
            content {
          ...
          dynamic "response_header_configuration" {
            for_each = rewrite_rule.value.response_header_configuration != null ? lookup(rewrite_rule.value, "response_header_configuration", {}) : []
            content {
          ...
          dynamic "url" {
            for_each = rewrite_rule.value.url != null ? lookup(rewrite_rule.value, "url", {}) : []
            content {
